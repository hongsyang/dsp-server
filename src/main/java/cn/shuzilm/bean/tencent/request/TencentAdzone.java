...
*/
@Data
public class TencentAdzone implements Serializable {
  ...
  private List<Integer>  exclude_landing_page_url;//  否int32 禁止的落地页
  private List<Integer>  creative_specs ;//  否int32 广点通 creative_specs 标识流量来源的位置
  private List<String>  seat_ids ;//  否string 灵集流量中增加竞价席位
  private YouYiVideo video ;//  否 Video
  private List<YouYiNative> Native ;//  否 NATIVE
  private List<YouYiPmp>   pmp ;//  否 PMP
  private String  is_deep_link ;//  否 bool
  private List<String>  billing_id ;//  否string
  private List<String>  mimes ;//  否string 素材类型
  private List<YouYiOTT>  ott ;//  否OTT
