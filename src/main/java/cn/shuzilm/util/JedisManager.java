...
public class JedisManager {
     ...
     * 构造函数
     */
    public JedisManager(String ip, int port, String shardName) {
//        initialPool();
        initialShardedPool(ip, port, shardName);
...
//        jedis = jedisPool.getResource();
   ...
   /* private void initialPool() {
     ...
     * 初始化切片池
     */
    private void initialShardedPool(String ip, int port, String shardName) {
        // 池基本配置
        JedisPoolConfig config = new JedisPoolConfig();
...
//        config.setMaxWait(1000l);
        ...
        shards.add(new JedisShardInfo(ip, port, shardName));
        // 构造池
...
//        shardedJedisPool.returnResource(shardedJedis);
    ...
    public void setMap(String key, String hKey, String hValue) {
        shardedJedis.hset(key, hKey, hValue);
...
//
        ...
        JedisManager jedis = new JedisManager("39.106.119.54", 6379, "work_live");
        jedis.setMap("AAA", "work_grid_id", "11");
        jedis.setMap("AAA", "work_city_id", "22");
