 ...
 * @Description: 百度点击解析
 * @Author: houkp
 * @CreateDate: 2019/4/9 10:50
 * @UpdateUser: houkp
 * @UpdateDate: 2019/4/9 10:50
 * @UpdateRemark: 修改内容
 * @Version: 1.0
 */
public class BaiduClickParameterParserImpl {
    private static final Logger log = LoggerFactory.getLogger(BaiduClickParameterParserImpl.class);
    ...
    public static String parseUrlStr(String url) {
        ...
        MDC.put("sift", "BaiduClick");
        log.debug("BaiduClick点击的url值:{}", url);
        Map<String, String> urlRequest = UrlParserUtil.urlRequest(url);
        log.debug("BaiduClick点击之后的url值:{}", urlRequest);
        ...
        try {
            ...
            log.debug("BaiduClick点击的requestid:{},element值:{}", requestId, element);
            ...
            bean.setType(1);
            //pixel服务器发送到主控模块
            log.debug("pixel服务器发送到主控模块的BaiduClickBean：{}", bean);
            ...
            Help.sendAlert("发送到" + configs.getString("HOST") + "失败, BaiduClick");
