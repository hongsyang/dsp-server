 ...
 * @Version: 1.0
 */
public class COPYAdViewNurlParameterParserImpl implements ParameterParser {

    private static final Logger log = LoggerFactory.getLogger(COPYAdViewNurlParameterParserImpl.class);
