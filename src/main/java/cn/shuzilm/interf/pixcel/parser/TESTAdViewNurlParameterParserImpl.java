 ...
 * @Version: 1.0
 */
public class TESTAdViewNurlParameterParserImpl implements ParameterParser {

    private static final Logger log = LoggerFactory.getLogger(TESTAdViewNurlParameterParserImpl.class);
