 ...
 * @Version: 1.0
 */
public class TencentClickParameterParserImpl implements ParameterParser {

    private static final Logger log = LoggerFactory.getLogger(TencentClickParameterParserImpl.class);
