...
public class BidResponseTest {
    ...
    public static void main(String[] args) {
        ...
        String price1 = response.substring(response.indexOf("price\":"));
        String s = price1.substring(7, price1.indexOf(","));
        Double bidfloorcur = Double.valueOf(s);
...
//        System.out.println(   jsonObject.getString("price"));
        ...
        System.out.println(substring.substring(0, substring.indexOf('"')).replace("lingjiclick","lingjiexp"));
